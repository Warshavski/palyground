...
RUN groupadd --gid 1005 playground_user \
  && useradd --uid 1005 --gid playground_user --shell /bin/bash --create-home playground_user
USER playground_user
RUN mkdir /home/playground_user/app
WORKDIR /home/playground_user/app
...
ENV RAILS_ENV=production \
  ...
  BUNDLE_JOBS=4 \
  BUNDLE_RETRY=3 \
  BUNDLE_APP_CONFIG=/home/playground_user/bundle \
  BUNDLE_PATH=/home/playground_user/bundle \
  GEM_HOME=/home/playground_user/bundle

# Install Ruby gems
COPY --chown=playground_user:playground_user Gemfile Gemfile.lock ./
RUN mkdir $BUNDLE_PATH \
  ...
  && rm -rf /home/playground_user/.bundle/cache/*

# Copy code
COPY --chown=playground_user:playground_user . .
...
ENV RAILS_ENV=production \
  ...
  BUNDLE_PATH=/home/playground_user/bundle \
  GEM_HOME=/home/playground_user/bundle \
  PATH="/home/playground_user/app/bin:${PATH}" \
  LANG=C.UTF-8 \
  LC_ALL=C.UTF-8
...
COPY --from=production-builder /home/playground_user/app/public/packs /home/playground_user/app/public/packs
# 3) We can even copy the Bootsnap cache to speed up our Rails server load!
COPY --chown=playground_user:playground_user --from=production-builder /home/playground_user/app/tmp/cache/bootsnap* /home/playground_user/app/tmp/cache/
